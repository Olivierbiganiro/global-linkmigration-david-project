        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('dashboard') }}" wire:navigate
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white {{ request()->routeIs('admin.dashboard*') ? 'bg-gray-100 dark:bg-gray-700' : 'hover:bg-gray-100 dark:hover:bg-gray-700' }} group">
            ...
            @elseif($userRole == UserRole::USER->value && auth()->user()->invoice && auth()->user()->invoice->status == true)
                <li>
                    <a href="#"
