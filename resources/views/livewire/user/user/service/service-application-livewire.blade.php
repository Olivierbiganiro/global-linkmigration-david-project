                ...
                <div class="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    @if ($selectedService)
                        ...
                        <div class="bg-gray-50 rounded-xl p-6 mb-6">
                            <h3 class="text-xl font-semibold text-gray-900 mb-2">{{ $selectedService->name }}</h3>
                            ...
                            <div class="text-right">
                                <span
                                    class="text-2xl font-bold text-gray-900">{{ number_format($selectedService->price, 2) }} {{ $selectedService->currency }}</span>
                            </div>
                        </div>
