<div class="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 relative overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $services->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div
                    ...
                    <div class="flex items-center h-64">
                        ...
                        <div class="flex-1 p-8">
                            <h3 class="text-2xl font-bold text-gray-900 mb-3"><?php echo e($service->name); ?></h3>
                            <p class="text-gray-700 mb-6 text-lg leading-relaxed"><?php echo e(str($service->description)->words(20)->toString()); ?></p>
                            <p class="text-gray-700 mb-6 text-lg leading-relaxed"><?php echo e($service->price); ?> <?php echo e($service->currency); ?></p>

                            <!-- Call to Action Button -->
                            <a href="<?php echo e(route('user.service.apply', $service->id)); ?>"
                            ...
                            <div class="hexagon w-full h-full relative overflow-hidden">
                                <!--[if BLOCK]><![endif]--><?php if($service->image): ?>
                                    ...
                                    <div class="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center"
                                        style="display: none;">
                                        <div
                                            class="w-12 h-12 <?php echo e($index); ?> rounded-full flex items-center justify-center">
...
<?php /**PATH D:\2025\academia_vision\global-linkmigration\resources\views/livewire/user/user/service/user-service-livewire.blade.php ENDPATH**/ ?>