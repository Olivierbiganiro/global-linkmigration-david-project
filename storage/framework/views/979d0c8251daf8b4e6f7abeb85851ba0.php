                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <!--[if BLOCK]><![endif]--><?php if($service->image): ?>
                                    <img src="<?php echo e(Storage::url($service->image)); ?>" alt="<?php echo e($service->name); ?>"
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 max-w-xs truncate"><?php echo e($service->description); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">$<?php echo e(number_format($service->price, 2)); ?>

                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?php echo e($service->status ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center gap-2">
                                    <button wire:click="edit(<?php echo e($service->id); ?>)"
                ...
                <div class="mt-3">
                    ...
                    <div class="flex items-center justify-between pb-4 border-b">
                        <h3 class="text-lg font-medium text-gray-900">
                            <?php echo e($serviceId ? 'Edit Service' : 'Create New Service'); ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" wire:model="price" id="price" step="0.01"
                                        min="0"
                                        class="w-full pl-7 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="md:col-span-2">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($image): ?>
                                    <div class="mb-2">
                                        <img src="<?php echo e($image->temporaryUrl()); ?>" alt="Preview"
                                            class="h-20 w-20 object-cover rounded-lg">
                                    </div>
                                <?php elseif($existingImage): ?>
                                    <div class="mb-2">
                                        <img src="<?php echo e(Storage::url($existingImage)); ?>" alt="Current image"
                                            class="h-20 w-20 object-cover rounded-lg">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="flex justify-end gap-3 mt-6 pt-4 border-t">
                            ...
                            <button type="submit"
                                ...
                                <?php echo e($serviceId ? 'Update Service' : 'Create Service'); ?>
...
<?php /**PATH D:\2025\academia_vision\global-linkmigration\resources\views/livewire/user/admin/services/services-livewire.blade.php ENDPATH**/ ?>